...
# 
# Over a short period of time, the TWA is closely approximated by `TWA = 182 - HDG`, with an average error of about 2.5 degrees.
# 
...
# 
# **Are we done?**  Sadly no, because there are still significant flaws.
# 
